...
| `docs/contracts/r_source_drift_inventory_v1.md` | `bd-01M0DQSE2QBF4TZ6G9DKYY8G2W` | `uv run pytest tests/test_group/test_examine_group.py tests/test_hrf/test_estimate_hrf.py -q` | 2026 R-source drift wave map and remaining S2 rows | `keep` |
