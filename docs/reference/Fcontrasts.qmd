...
runtime type (registered for `EventTerm`, `EventModel`,
...
|-----------|--------|--------------------------------------------------------------------|------------|
| x         | object | Object to generate F-contrasts for (event_term, event_model, etc.) | _required_ |
| max_inter | int    | Maximum interaction order to include (default: 4)                  | `4`        |
| **kwargs  | Any    | Additional arguments passed to specific methods                    | `{}`       |

## Returns {.doc-section .doc-section-returns}

| Name   | Type               | Description                                            |
|--------|--------------------|--------------------------------------------------------|
|        | Dict\[str, Array\] | Dictionary mapping contrast names to contrast matrices |
