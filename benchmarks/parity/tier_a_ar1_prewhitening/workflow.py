...
def make_case(max_voxels: int = MAX_VOXELS) -> ParityCase:
    ...
    return ParityCase(
        ...
        tolerances={
            ...
            # within atol=0.01.
            # tolerance_rationale: Tier B AR algorithms differ but must
            # preserve per-voxel effect rankings.
            "per_voxel_beta_corr_A": ParityTolerance(rtol=0.0, atol=0.01),
            "per_voxel_beta_corr_B": ParityTolerance(rtol=0.0, atol=0.01),
            # tolerance_rationale: intercept stays robust to AR algorithm
            # choice; the 1e-2 floor catches regressions in that near-match.
            ...
            # divergence.
            # tolerance_rationale: bound the documented absolute beta gap
            # without claiming strict allclose parity.
