...
BASELINE_REVIEW_PENDING_NAMES = frozenset({
    ...
    "contrast_weights", "create_design_matrix_from_benchmark", "data_chunks", "design_matrix",
    "design_plot", "detect_group_data_format", "drift", "dvars_to_weights",
    "estimate", "estimate_betas", "estimate_hrf", "evaluate",
    "evaluate_method_performance", "event_factor", "event_matrix", "event_term",
    "event_variable", "extract_csv_data", "fit_contrasts", "fit_glm_on_transformed_series",
    "fit_glm_with_config", "fit_noise", "fitted_hrf", "flip_sign",
    "fmri_latent_lm", "fmri_mem_dataset", "fmri_meta_fit", "fmri_meta_fit_contrasts",
    "fmri_meta_fit_cov", "fmri_meta_fit_extended", "fmri_ols_fit", "fmri_rlm",
    ...
    "get_benchmark_summary", "get_contrasts", "get_covariates", "get_data",
    "get_data_matrix", "get_formula", "get_hrf", "get_mask",
    "get_rois", "get_subjects", "glm_lss", "glm_ols",
    "global_onsets", "group_data", "group_data_from_csv", "group_data_from_h5",
    "group_data_from_nifti", "hrf_blocked", "hrf_bspline_generator", "hrf_daguerre_generator",
    "hrf_fir_generator", "hrf_formula", "hrf_fourier_generator", "hrf_lagged",
    "hrf_set", "hrf_smoothing_kernel", "hrf_spmg1", "hrf_tent_generator",
    "interaction_contrast", "intercept", "is_spec", "lag_hrf",
    "latent_dataset", "list_available_hrfs", "list_benchmark_datasets", "load_benchmark_dataset",
    "lowrank_control", "lsa_single_trial", "lss_single_trial", "matrix_dataset",
    "meta_effective_n", "n_subjects", "null_regressor", "one_against_all_contrast",
    "oneway_contrast", "p_values", "pair_contrast", "paired_diff_block",
    "pairwise_contrasts", "poly_contrast", "pvalues", "r_to_z",
    "read_fmri_config", "read_h5_full", "read_nifti_full", "register_basis",
    "regressor", "regressor_set", "resolve_basis", "samples",
    "sandwich_from_whitened_resid", "se", "shift", "simulate_bold_signal",
    "simulate_fmri_matrix", "simulate_noise_vector", "simulate_simple_dataset", "sliding_window_contrasts",
    "soft_projection", "soft_subspace_options", "spec_diff", "spm_canonical",
    "standard_error", "stats", "t_to_beta_se", "t_to_d",
    "tidy", "tidy_fitted_hrf", "unit_contrast", "volume_weights",
    "voxel_index_chunks", "whiten", "whiten_apply", "write_results",
    "z_to_r", "zscores",
})
...
def test_baseline_size_is_known() -> None:
    ...
    assert len(BASELINE_REVIEW_PENDING_NAMES) == 186, (
        f"BASELINE_REVIEW_PENDING_NAMES size drifted from 186 to "
